...
\say{Cada archivo \texttt{.npz} puede contener una o varias series temporales, 
...
% parrafofr introductio de la imagen 
...
calulados con el método de suma acumulada. \say{Se observan unas líneas horizontales rojas, 
éstas nos indican los
periodos de tiempo en los cuales no se detectaron cambios en la media de las observaciones.
El número de observación o el punto en el cual se suspende la continuidad de la línea roja es
justo el punto de cambio detectado.} \citep{contreras2024cusum}. Existen cambios más intensos
...
redes neuronales. \say{El elemento esencial será la neurona artificial, 
la cual se organizará en capas. Varias capas constituirán una red neuronal. 
Finalmente una red neuronal junto con los interfaces de entrada y salida constituirá 
el sistema global de proceso} \citep{larranaga2021redes}.
...
están relacionadas con el \say{aspecto} de la señal. 
